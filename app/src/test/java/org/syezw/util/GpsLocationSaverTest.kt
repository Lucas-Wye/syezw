...
class GpsLocationSaverTest {
    @Test
    fun saveLocation_updatesEndTime_whenReadingIsNearPreviousPoint() =
        runBlocking {
            val dao =
                FakeGpsLocationDao(
                    initialLocations =
    ...
    @Test
    fun saveLocation_keepsEndTimeMonotonic_whenNearPointIsOlder() =
        runBlocking {
            val dao =
                FakeGpsLocationDao(
                    initialLocations =
    ...
    @Test
    fun saveLocation_insertsNewLocation_whenReadingIsFarAway() =
        runBlocking {
            val dao =
                FakeGpsLocationDao(
                    initialLocations =
